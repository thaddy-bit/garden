...
export default function PremiumFooterWithImages() {
  const scrollToTop = () => {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="text-center space-y-4">
                <h3 className="text-lg font-bold text-green-400">Modes de paiement</h3>
                <p className="text-gray-300 text-sm">
                  Nous acceptons tous les modes de paiement sécurisés
                </p>
                <div className="flex flex-wrap justify-center gap-3">
                  <div className="group relative w-16 h-10 bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <Image 
                      src="/images/visa.png" 
                      alt="Visa" 
                      width={64} 
              ...
              <div className="text-center space-y-4">
                <h3 className="text-lg font-bold text-green-400">Livraison mondiale</h3>
                <p className="text-gray-300 text-sm">
                  Livraison rapide et sécurisée avec nos partenaires
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  <div className="group relative w-20 h-12 bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <Image 
                      src="/images/dhl.png" 
                      alt="DHL" 
                      width={80} 
